...
enml = {
  ...
  odometry_radial_stddev_rate = 0.3;
  odometry_tangential_stddev_rate = 0.3;
  odometry_angular_stddev_rate = 1.5;
  ...
  map_correlation_factor = 1.0 / 20.0;
  ...
  visibility_correlation_factor = 1.0 / 20.0;
